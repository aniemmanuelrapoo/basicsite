                                    ...
                                    <div class="pt-0">
                                        <form class="my-4" method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input class="form-control" name="password_confirmation" type="password" required="" id="password_confirmation" placeholder="Enter Confirmation Password">
                                            </div>
                                        ...
                                        <div class="text-center text-muted mb-4">
                                            <p class="mb-0">Want to login ?<a class='text-primary ms-2 fw-medium' href="{{ route('login') }}">Sing in</a></p>
                                        </div>
